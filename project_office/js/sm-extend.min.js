...
$(document).on("pageInit", "#page-toast", function(e, id, page) {
    $(page).on('click','#toast1', function () {
      $.toast('操作失败');
    });
    $(page).on('click','#toast2', function () {
      $.toast('操作成功，正在跳转...', 3000, 'toast-height');
    });
  });

$(document).on("pageInit", "#page-donghua", function(e, id, page) {
...
$(document).on("pageInit", "#page-pg", function(e, id, page) {
	$(page).on('click','#audio_btn',function(){
		 var music = document.getElementById("music"); 
    if(music.paused){ 
        music.play(); 
        $("#music_btn").removeClass("icon-10").addClass("icon-9");
    }else{ 
        music.pause(); 
        $("#music_btn").removeClass("icon-9").addClass("icon-10"); 
    }
	})
	
	$(page).on('swipe','#items li',function(){
