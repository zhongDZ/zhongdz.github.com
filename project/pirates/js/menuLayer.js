var menuLayer = cc.Layer.extend({
    ...
    initMenu : function(){
        var _X1 = 55,
            ...
            _Y2 = 130;
        //排行榜按钮
        var _phbBtn = new basicSprite(this, res.phbBtn, _X1, _Y1, true, this.phbBtnFun);
        //邀请按钮
        var _invoteBtn = new basicSprite(this, res.invoteBtn, _X1, _Y1 - 120, true, this.invoteBtnFun, true);
        //指南针按钮
        var _panBtn = this._panBtn = new basicSprite(this, res.panBtn, _X2, _Y1);
        var _panBtn1 = this._panBtn1 = new basicSprite(this, res.panBtn1, _X2, _Y1, true, this.panBtnFun);
        _panBtn1.zIndex = 3;
        //海盗助手
        var _helpBtn = this._helpBtn = new basicSprite(this, res.helpBtn, _X2, _Y1 - 120, true, this.helpBtnFun, true);
        //打怪兽
        var _fightBtn = this._fightBtn = new basicSprite(this, res.fightBtn, _X2, _Y1 - 240, true, this.fightBtnFun, true);
        //地图
        var _mapBtn = this._mapBtn = new basicSprite(this, res.mapBtn, _X1 + 5, _Y2 - 50, true, this.mapBtnFun);
        //自己的岛屿
        var _selfBtn = new basicSprite(this, res.selfBtn, _X2 - 20, _Y2 + 100, true, this.slefBtnFun, true);
        var st = new cc.scaleTo(1, 1.1);
        var st1 = new cc.scaleTo(1, 1);
        var seq = new cc.sequence(st, st1).repeatForever();
        _selfBtn.runAction(seq)
        //金蛋
        var _eggBtn = this._eggBtn = new basicSprite(this, res.eggBtn, _X2 - 20, _Y2 - 50, true, this.eggBtnFun);
        //每日登陆
        var _everyDayBtn = this._everyDayBtn = new basicSprite(this, res.everyDayBtn, _X2, _Y1, true, this.everyDayBtnFun);
        _everyDayBtn.visible = false;
        //新手礼包
        var _new_player_btn = this._new_player_btn = new basicSprite(this, res.newPlayerBtn, _X2, _Y1, true, this.newPlayerBtnFun);
        _new_player_btn.visible = false;
        //游戏帮助
        var _G_help_btn = this._G_help_btn = new basicSprite(this, res.GhelpBtn, _X2, _Y1, true, this.GhelpBtnFun);
    ...
    initStar : function(){
        ...
        var sprArr = [];
        for(var i = 0;i < 8;i++){
            var spr = new cc.Sprite(res.star);
            spr.x = starPos[i][0];
            spr.y = starPos[i][1];
            spr.scale = 0.5;
            sprArr.push(spr);
