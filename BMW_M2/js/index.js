...
function aniEnd(dom, callFun){
    var _dom = $(dom);
    _dom.one("webkitAnimationEnd", function(){ //动画开始时事件 
...
aniEnd('.p27', function(){
    ...
    $('.p27').addClass('fadeinout');
    $('.p28').addClass('fadeinout');

    $('.p27').off().on('click', function(){
        $('.p29').removeClass('dis_none');

        $('.p27').removeClass('fadeinout');
    });
    $('.p28').off().on('click', function(){
        $('.p210').removeClass('dis_none');

        $('.p28').removeClass('fadeinout');
    });
});
...
aniEnd('.p36', function(){
    ...
    $('.p36').addClass('fadeinout');

    $('.p36').off().on('click', function(){
        $('.p210').removeClass('dis_none');
        $('.p36').removeClass('fadeinout');
    });
});
...
aniEnd('.p46', function(){
    ...
    $('.p46').addClass('fadeinout');

    $('.p46').off().on('click', function(){
        $('.p47').removeClass('dis_none');
        $('.p46').removeClass('fadeinout');
    });
});
...
aniEnd('.p58', function(){
    ...
    $('.p57').addClass('fadeinout');
    $('.p58').addClass('fadeinout');

    $('.p57').off().on('click', function(){
        $('.p59').removeClass('dis_none');
        $('.p57').removeClass('fadeinout');
    });
    $('.p58').off().on('click', function(){
        $('.p510').removeClass('dis_none');
        $('.p58').removeClass('fadeinout');
    });
});


$('.p64').off().on('click', function(){
    $('.infoPop').removeClass('dis_none');
    $('.infoPop').addClass("animated bounceIn")
});
