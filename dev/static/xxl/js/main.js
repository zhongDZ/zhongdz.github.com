var MyLoaderScene = cc.Scene.extend({
    ...
    init : function(){
        ...
        //loading logo
        // cc.loader.loadImg(res.loadinPage, {isCrossOrigin : false }, function(err, img){
        //     var beginbackground = cc.Sprite.create(res.loadinPage);
...
function resourceCallBack(){
    cc.game.onStart = function(){
        ...
        if(thisismobile){
            cc.view.setDesignResolutionSize(640, 1000, cc.ResolutionPolicy.EXACT_FIT);
        }else{
