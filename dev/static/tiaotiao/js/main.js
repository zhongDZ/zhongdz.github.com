...
var MyLoaderScene = cc.Scene.extend({
    ...
    init : function(){
        ...
        // var logoRound = new cc.Sprite(res.logoRound);
        // logoRound.x = size.width/2;
        // logoRound.y = size.height/2;
        // this.addChild(logoRound);

        // var r = cc.rotateBy(3,360);
        // var repeat = r.repeatForever();
        // logoRound.runAction(repeat);
...
function resourceCallBack(){
    cc.game.onStart = function(){
        ...
        if(thisismobile){
            cc.view.setDesignResolutionSize(576, 1024, cc.ResolutionPolicy.SHOW_ALL);
        }else{
            cc.view.setDesignResolutionSize(576, 1024, cc.ResolutionPolicy.SHOW_ALL);
        }
