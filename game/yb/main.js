...
var MyLoaderScene = cc.Scene.extend({
    ...
    init : function(){
        ...
        var size = cc.director.getWinSize();
        if("res/loadingpage.jpg"){
            //loading logo
            cc.loader.loadImg("res/loadingpage.jpg", {isCrossOrigin : false }, function(err, img){
                var beginbackground = cc.Sprite.create("res/loadingpage.jpg");
