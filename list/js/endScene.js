var endsuccessScene = cc.Scene.extend({
    ...
    init:function(){
        ...
        var endBg  = new cc.Sprite(res.endBg);
        endBg.x = size.width/2;
        endBg.y = size.height/2;
        this.addChild(endBg, 1);

        var success = new cc.Sprite(res.success);
        ...
        shine.x = size.width/2;
        shine.y =  size.height - 135;
        this.addChild(shine);

        var st2 = new cc.scaleTo(1, 1.2);
        var st2call = new cc.callFunc(function(){
            shine.scale = 1;
        },this);
        var seq = new cc.sequence(st2, st2call);
        var st2repeat = seq.repeatForever();
        shine.runAction(st2repeat)
